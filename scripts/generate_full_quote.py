...
rows = [
    ...
    {"序号":7, "产品规格":"日志审计‑10资产", "详细规格说明":"支持 10 条日志源（每条对应一个 IP），实时采集云上网络、主机、应用日志，集中存储、索引、全文检索、备份、审计、告警、报表。", "标准价（1 月）":1107, "标准价（1 年）":13284, "折扣价（包年）":11291, "结算价 4.5折":5081, "结算价 5.5折":6210, "备注":"包年1年85折，2年75折，3年65折"},
...
output_path = r"c:/Users/lpcis/WorkBuddy/Ctyun-quote/quote/等保专区三级等保基础版报价.xlsx"
with pd.ExcelWriter(output_path, engine='openpyxl') as writer:
    ...
    for row in ws.iter_rows(min_row=2, max_row=ws.max_row, min_col=1, max_col=10):
        for cell in row:
            ...
            cell.border = border
    # Highlight discount columns G,H,I (折扣价, 4.5折, 5.5折)
